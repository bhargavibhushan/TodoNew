...
const Registration = () => {
      ...
      async function save(e)
      {
        e.preventDefault();
        try{
          await axios.post("http://localhost:9058/api/saveUser",{
            username:username,
            email:email,
            password:password,
          });
              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="button" class="btn btn-primary btn-lg" onClick ={save}>Register</button>
                  </div>
                  <br />
                  <span>
                   <p> Already have an account? <span><NavLink to="/">Sign In</NavLink></span> </p>
                  </span>
                </form>
              </div>
